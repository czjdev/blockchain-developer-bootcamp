...
describe("Exchange", () => {
  let exchange, deployer, feeAccount, user1, user2, token1, token2
  const feePercent = 10
  ...
  describe("Making orders", () => {
    ...
    describe("Failure", async () => {
      it("rejct with no balance", async () => {
  ...
  describe("Order actions", async () => {
    ...
    describe("Cancelling orders", async () => {
      ...
      describe("Failure", async () => {
        it("rejects invalid order ids", async () => {
          await expect(exchange.connect(user1).cancelOrder(99999)).to.be.reverted
        })
    ...
    describe("Filling orders", async () => {
      describe("Success", async () => {
        ...
        it("executes a trade and charges fees", async () => {
          // token give
      ...
      describe("Failure", async () => {
        it("rejects invalid order ids", async () => {
          await expect(exchange.connect(user2).fillOrder(99999)).to.be.reverted
        })
